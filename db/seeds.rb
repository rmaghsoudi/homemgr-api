...
5.times do
   GroceryItem.create!(category: 'Fresh Produce', title: Faker::Food.fruits, user_id: romy.id, image: "http://lorempixel.com/200/200")
end
5.times do
  GroceryItem.create!(category: 'Fresh Produce', title: Faker::Food.vegetables, user_id: romy.id, image: "http://lorempixel.com/200/200")
end
item1 = GroceryItem.create!(category: 'Cleaning', title: 'Fabuloso', user_id: romy.id, image: "http://lorempixel.com/200/200")
item2 = GroceryItem.create!(category: 'Cleaning', title: 'Chlorox Wipes', user_id: romy.id, image: "http://lorempixel.com/200/200")
item3 = GroceryItem.create!(category: 'Cleaning', title: 'Window Cleaner', user_id: romy.id, image: "http://lorempixel.com/200/200")
